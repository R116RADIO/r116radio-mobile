...
/**
 * authorized -   audios has authorized this permission
 *
 * denied -       audios has denied this permission at least once. On iOS this
 *                means that the audios will not be prompted again. Android users
 *                can be promted multiple times until they select 'Never ask me again'
 *
 * restricted -   (iOS only) audios is not able to grant this permission,
 *                either because it's not supported by the device or because
 *                it has been blocked by parental controls.
 *
 * undetermined - audios has not yet been prompted with a permission dialog
 *                or audios denied by selecting 'Never ask me again' on android.
 *
**/
